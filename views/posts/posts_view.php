<? foreach ($tags as $tag): ?><a href="posts/view/<?= $post['post_id'] ?>"><span class="label label-info"><?= $tag['tag_name'] ?></span>
    </a> <? endforeach ?>
<div class="span8">
    ...
    <div>
        ...
        <div class="pull-right">
            <? foreach ($tags as $tag): ?><a href="#"><span class="label label -info">
                    <?= $tag['tag_name'] ?></span></a>
            <? endforeach ?>
